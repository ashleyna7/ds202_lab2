...
Which company has had the most ratings overall in recent years? 

6 \. Bonus points (optional): Answer the question from the dataset.

```{r}

sort(table(recent_rating$Company), decreasing = TRUE)[1:3]


```

Soma A. has had the most reviews with 34 reviews in recent years. 
